<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="HRM.HR_Managment.Definition.Holiday.List" %>
        ...
        <ContentTemplate>
            <div id="wizard" style="margin: 0px; width: auto; height: auto;">
                <div class="page" style="width: 93%;">
                    <h2>
                        <font color="#707070"><strong>Holiday Groups list</strong></font>
                        <asp:HyperLink ID="NewHolidayHyperLink" runat="server" CssClass="fltrht employeeLinkLast employeeLink employeeLinkWithoutEm"
                            NavigateUrl="~/HR-Managment/Definition/Holiday/Add.aspx">Add new</asp:HyperLink>
                    </h2>
                    ...
                    <div style="width: 100%;">
                        <asp:GridView ID="HolidayGroupGridView" runat="server" AutoGenerateColumns="False" DataSourceID="HolidayGroupObjectDataSource"
                            EnableModelValidation="True" AllowPaging="True" OnDataBound="HolidayGroupGridView_DataBound">
                            <Columns>
                                <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id">
                                    <ItemStyle Width="50px" />
                                </asp:BoundField>
                                <asp:BoundField DataField="Title" HeaderText="Title" SortExpression="Title" />
                                <asp:HyperLinkField Text="Edit" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="Edit.aspx?HolidayGroupId={0}">
                                    <HeaderStyle Width="50px" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField Text="Delete" ControlStyle-CssClass="confirmNeeded" DataNavigateUrlFields="Id"
                                    DataNavigateUrlFormatString="List.aspx?HolidayGroupId={0}&action=delete">
                            ...
                            <EmptyDataTemplate>
                                <div style="text-align: center">
                                    <label runat="server" id="NoLeaveTypeLabel" style="font-size: 15px;">
                                        No Holiday groups were found! Insert and it will be shown here.</label>
                                </div>
                            </EmptyDataTemplate>
                        </asp:GridView>
                        <asp:ObjectDataSource ID="HolidayGroupObjectDataSource" runat="server" SelectMethod="List"
                            TypeName="DAL.Mapper.HolidayGroupMapper">
                            <SelectParameters>
