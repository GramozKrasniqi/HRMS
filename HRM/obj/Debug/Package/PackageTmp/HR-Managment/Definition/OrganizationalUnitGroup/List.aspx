<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="HRM.HR_Managment.Definition.OrganizationalUnitGroup.List" %>
        ...
        <ContentTemplate>
            <div id="wizard" style="margin: 0px; width: auto; height: auto;">
                <div class="page" style="width: 93%;">
                    <h2>
                        <font color="#707070"><strong>Unit group list</strong></font>
                        <asp:HyperLink ID="NewLeaveTypeHyperLink" runat="server" CssClass="fltrht employeeLinkLast employeeLink employeeLinkWithoutEm"
                            NavigateUrl="~/HR-Managment/Definition/OrganizationalUnitGroup/Add.aspx">Add new</asp:HyperLink>
                    </h2>
                        ...
                        <ul id="double">
                            ...
                            <li class="second">
                                ...
                                <asp:Button ID="Button1" CssClass="secondaryButton firstsecondaryButton" ToolTip="Clear"
                                    runat="server" Text="Clear" OnClientClick="document.location.href=document.location.href;"></asp:Button>
                                <asp:Button ID="newListTypeFilterButton" ToolTip="Save" CssClass="secondaryButton"
                                    ValidationGroup="Education" runat="server" Text="Filter" PostBackUrl="~/HR-Managment/Definition/OrganizationalUnitGroup/List.aspx"></asp:Button>
                            </li>
                        </ul>
                    </div>
                    <div style="width: 100%;">
                        <asp:GridView ID="LeaveTypeGridView" runat="server" AutoGenerateColumns="False" DataSourceID="LeaveTypeObjectDataSource"
                            ...
                            ondatabound="LeaveTypeGridView_DataBound">
                            <Columns>
                                <asp:BoundField DataField="Id" HeaderText="Id" SortExpression="Id" />
                                <asp:BoundField DataField="Title" HeaderText="Title" SortExpression="Title" />
                                <asp:HyperLinkField Text="Edit" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="Edit.aspx?UnitGroupId={0}">
                                    <HeaderStyle Width="50px" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField Text="Delete" ControlStyle-CssClass="confirmNeeded" DataNavigateUrlFields="Id"
                                    DataNavigateUrlFormatString="List.aspx?UnitGroupId={0}&action=delete">
                                    <HeaderStyle Width="50px" />
                                </asp:HyperLinkField>
                            </Columns>
                            <EmptyDataTemplate>
                                <div style="text-align: center">
                                    <label runat="server" id="NoLeaveTypeLabel" style="font-size: 15px;">
                                        No unit groups found! Insert and it will be shown here.</label>
                                </div>
                            </EmptyDataTemplate>
                            <PagerTemplate>
                        ...
                        <asp:ObjectDataSource ID="LeaveTypeObjectDataSource" runat="server" SelectMethod="List"
                            TypeName="DAL.Mapper.OrganizationalUnitGroupMapper">
                            <SelectParameters>
