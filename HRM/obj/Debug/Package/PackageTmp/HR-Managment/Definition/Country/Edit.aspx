<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="HRM.HR_Managment.Definition.Country.Edit" %>
...
<div id="wizard" style="margin: 0px; height: auto; width: auto;">
        <div class="page" style="width: 93%; height: 350px;">
            ...
            <h2>
                <font color="#707070"><strong>Edit country: </strong></font><em>Please enter country information: </em>
            </h2>
                ...
                <ul id="double">
                    <li>
                        ...
                        <asp:RequiredFieldValidator ID="TitleRequiredFieldValidator" ControlToValidate="TitleTextBox"
                            Display="None" runat="server" ErrorMessage="Please write a country name."></asp:RequiredFieldValidator>
                    </li>
                </ul>
                <ul class="full">
                    <li>
