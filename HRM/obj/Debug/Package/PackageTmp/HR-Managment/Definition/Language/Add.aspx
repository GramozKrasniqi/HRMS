<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Add.aspx.cs" Inherits="HRM.HR_Managment.Definition.Language.Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div id="wizard" style="margin: 0px; height: auto; width: auto;">
        <div class="page" style="width: 93%; height: 350px;">
            ...
            <h2>
                <font color="#707070"><strong>Insert a new language: </strong></font><em>Please enter
                    language information: </em>
            </h2>
