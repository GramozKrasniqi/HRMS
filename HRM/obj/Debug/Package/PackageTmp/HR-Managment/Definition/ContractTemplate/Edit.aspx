<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Edit.aspx.cs" Inherits="HRM.HR_Managment.Definition.ContractTemplate.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="wizard" style="margin: 0px; height: auto; width: auto;">
        <div class="page" style="width: 93%;">
            ...
            <h2>
                <font color="#707070"><strong>Contract template information - language / <asp:Label ID="LanguageLabel" runat="server">Shqip</asp:Label> </strong></font><em>Please
                    enter contract template information: </em>
            </h2>
            <div style="margin-bottom: 15px;">
                <ul id="double2">
                    <li>
                        <label runat="server" for="ContractTemplateTitleTextBox" id="ContractTemplateTitleLabel">
                            Template title:</label>
                        <asp:TextBox ID="ContractTemplateTitleBox" runat="server" TabIndex="1"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="ContractTemplateTitleRequiredFieldValidator" ControlToValidate="ContractTemplateTitleBox"
                            Display="None" runat="server" ErrorMessage="Please enter contract template title."></asp:RequiredFieldValidator>
                    </li>
                    <li class="second">
                        <label runat="server" for="ContractPreffixTextBox" id="ContractPreffixLabel">
                            Contract preffix:</label>
                        <asp:TextBox ID="ContractPreffixTextBox" runat="server" TabIndex="2"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="ContractPreffixValidator" ControlToValidate="ContractPreffixTextBox"
                            Display="None" runat="server" ErrorMessage="Please enter contract preffix."></asp:RequiredFieldValidator>
                    </li>
                </ul>
                <ul id="double">
                    <li>
            ...
            <CKEditor:CKEditorControl ID="CKEditor1" runat="server" Height="500" BasePath="~/ckeditor"
                ...
                TabIndex="6"></CKEditor:CKEditorControl>
