	...
	$(function() {
		...
		var u = navigator.userAgent.toLowerCase(),
			...
			css_string = '' + 
				...
				'.jstree li { min-height:18px; line-height:18px; white-space:nowrap; margin-left:18px; min-width:18px; float: left !important; clear: both !important; display:block !important; margin-bottom: 10px;} ' + 
	...
	$.jstree.plugin("checkbox", {
		...
		_fn : {
			...
			get_checked : function (obj, get_all) {
				...
				return get_all || this._get_settings().checkbox.two_state ? obj.find(".jstree-checked, .jstree-undetermined") : obj.find("> ul > .jstree-checked, .jstree-undetermined > ul > .jstree-checked");
			},
