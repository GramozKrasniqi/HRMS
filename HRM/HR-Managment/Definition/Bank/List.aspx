<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="HRM.HR_Managment.Definition.Bank.List" %>
                        ...
                        <ul id="double">
                            ...
                            <li class="second">
                                ...
                                <asp:Button ID="newListTypeFilterButton" ToolTip="Save" CssClass="secondaryButton"
                                    ValidationGroup="Education" runat="server" Text="Filter" PostBackUrl="~/HR-Managment/Definition/Bank/List.aspx"></asp:Button>
                            </li>
                        </ul>
                    </div>
                    <div style="width: 100%;">
                        <asp:GridView ID="LeaveTypeGridView" runat="server" AutoGenerateColumns="False" DataSourceID="LeaveTypeObjectDataSource"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField Text="Edit" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="Edit.aspx?BankId={0}">
                                    <HeaderStyle Width="50px" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField Text="Delete" ControlStyle-CssClass="confirmNeeded" DataNavigateUrlFields="Id"
                                    DataNavigateUrlFormatString="List.aspx?BankId={0}&action=delete">
                                    <HeaderStyle Width="50px" />
                                </asp:HyperLinkField>
                            </Columns>
                            <EmptyDataTemplate>
                                <div style="text-align: center">
                                    <label runat="server" id="NoLeaveTypeLabel" style="font-size: 15px;">
                                        No banks were found! Insert and it will be shown here.</label>
                                </div>
                            </EmptyDataTemplate>
                            <PagerTemplate>
                        ...
                        <asp:ObjectDataSource ID="LeaveTypeObjectDataSource" runat="server" SelectMethod="ListWithAdvancedFilter"
                            TypeName="DAL.Mapper.BankMapper">
                            <SelectParameters>
