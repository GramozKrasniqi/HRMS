<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    EnableEventValidation="false" CodeBehind="Add.aspx.cs" Inherits="HRM.HR_Managment.Definition.ContractTemplate.Add" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="wizard" style="margin: 0px; height: auto; width: auto;">
        <div class="page" style="width: 93%;">
            ...
            <h2>
                <font color="#707070"><strong>Contract template information - language /
                    <asp:Label ID="LanguageLabel" runat="server">Shqip</asp:Label></strong></font>
                <em>Please enter contract template information: </em>
            </h2>
