<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="List.aspx.cs" Inherits="HRM.HR_Managment.Definition.Nationalities.List" %>
        ...
        <ContentTemplate>
            <div id="wizard" style="margin: 0px; width: auto; height: auto;">
                <div class="page" style="width: 93%;">
                    <h2>
                        <font color="#707070"><strong>Nationalities list</strong></font>
                        <asp:HyperLink ID="NewLeaveTypeHyperLink" runat="server" CssClass="fltrht employeeLinkLast employeeLink employeeLinkWithoutEm"
                            NavigateUrl="~/HR-Managment/Definition/Nationalities/Add.aspx">Add new</asp:HyperLink>
                    </h2>
                        ...
                        <ul id="double">
                            ...
                            <li class="second">
                                ...
                                <asp:Button ID="newListTypeFilterButton" ToolTip="Save" CssClass="secondaryButton"
                                    ValidationGroup="Education" runat="server" Text="Filter" PostBackUrl="~/HR-Managment/Definition/Nationalities/List.aspx"></asp:Button>
                            </li>
                        </ul>
                    </div>
                    <div style="width: 100%;">
                        <asp:GridView ID="LeaveTypeGridView" runat="server" AutoGenerateColumns="False" DataSourceID="LeaveTypeObjectDataSource"
                            ...
                            <Columns>
                                ...
                                <asp:HyperLinkField Text="Edit" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="Edit.aspx?NationalityId={0}">
                                    <HeaderStyle Width="50px" />
                                </asp:HyperLinkField>
                                <asp:HyperLinkField Text="Delete" ControlStyle-CssClass="confirmNeeded" DataNavigateUrlFields="Id"
                                    DataNavigateUrlFormatString="List.aspx?NationalityId={0}&action=delete">
                                    <HeaderStyle Width="50px" />
                                </asp:HyperLinkField>
                            </Columns>
                            <EmptyDataTemplate>
                                <div style="text-align: center">
                                    <label runat="server" id="NoLeaveTypeLabel" style="font-size: 15px;">
                                        No nationalities were found! Insert and it will be shown here.</label>
                                </div>
                            </EmptyDataTemplate>
                            <PagerTemplate>
                        ...
                        <asp:ObjectDataSource ID="LeaveTypeObjectDataSource" runat="server" SelectMethod="List"
                            TypeName="DAL.Mapper.NationalityMapper">
                            <SelectParameters>
