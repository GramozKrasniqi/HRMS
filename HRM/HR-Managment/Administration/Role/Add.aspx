<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Add.aspx.cs" Inherits="HRM.HR_Managment.Administration.Role.Add" %>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            $("#demo").jstree({
                ...
                $("#demo ul li[selected='selected']").removeClass("jstree-unchecked").addClass("jstree-undetermined");
            });
    ...
    <div id="wizard" style="margin: 0px; height: auto; width: auto;">
        <div class="page" style="width: 93%;">
            ...
            <h2 style="border-top: 1px dotted #CCC; padding-top: 10px; margin-top: 10px; border-bottom: none;">
                <font color="#707070"><strong>Add role: </strong></font><em>Please
                    type the role information. </em>
            </h2>
