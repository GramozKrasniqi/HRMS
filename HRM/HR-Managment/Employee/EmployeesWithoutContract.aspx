<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="EmployeesWithoutContract.aspx.cs" Inherits="HRM.HR_Managment.Employee.EmployeesWithoutContract" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="wizard" style="margin: 0px; width: auto; height: auto;">
        <div class="page" style="width: 93%;">
            <h2>
                <font color="#707070"><strong>Employees without contract </strong></font><em>Please enter employee
            ...
            <div style="width: 100%;">
                <asp:GridView ID="EducationTrainingGridView" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:HyperLinkField Text="Contract" DataNavigateUrlFields="Id" DataNavigateUrlFormatString="JobDetails.aspx?EmployeeId={0}" />
                    </Columns>
                    <EmptyDataTemplate>
                ...
                <asp:ObjectDataSource ID="EducationTrainingObjectDataSource" runat="server" SelectMethod="ListWithAdvancedFilterWithoutContract"
