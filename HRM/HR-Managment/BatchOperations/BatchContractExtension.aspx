<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false"
    CodeBehind="BatchContractExtension.aspx.cs" Inherits="HRM.HR_Managment.BatchOperations.BatchContractExtension" %>
    ...
    <div id="wizard" style="margin: 0px; height: auto; width: auto;">
        <div class="page" style="width: 93%;">
            ...
            <h2 style="border-top: 1px dotted #CCC; padding-top: 10px; border-bottom: none;">
                <font color="#707070"><strong>Select dates for extension (Step 3): </strong></font>
                <em>Please select the start date and end date for the current extension: </em>
            </h2>
            <ul id="triple">
                <li>
            ...
            <h2 style="border-top: 1px dotted #CCC; padding-top: 10px; margin-top: 10px; border-bottom: none;">
                <font color="#707070"><strong>Select employees (Step 4): </strong></font><em>Please
