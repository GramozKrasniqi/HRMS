<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Edit.aspx.cs" Inherits="HRM.HR_Managment.OrganizationalUnit.Edit" EnableEventValidation="false"%>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="wizard" style="margin: 0px; height: auto; width: auto;">
        <div class="page" style="width: 93%;">
            ...
            <h2>
                <font color="#707070"><strong>Edit organizational unit</strong></font><em>Please enter
                    organizational unit information: </em>
            </h2>
